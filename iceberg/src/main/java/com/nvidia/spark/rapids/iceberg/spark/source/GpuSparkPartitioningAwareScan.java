...
/**
 * Derived from Apache Iceberg's SparkPartitioningAwareScan class.
 */
abstract class GpuSparkPartitioningAwareScan<T extends PartitionScanTask> extends GpuSparkScan
    implements SupportsReportPartitioning {

  private static final Logger LOG = LoggerFactory.getLogger(GpuSparkPartitioningAwareScan.class);
  ...
  GpuSparkPartitioningAwareScan(
    ...
    super(spark, table, readConf, expectedSchema, filters, scanReportSupplier, rapidsConf, queryUsesInputFile);
